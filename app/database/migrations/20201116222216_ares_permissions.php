...
final class AresPermissions extends AbstractMigration
{
    public function change(): void
    {
        ...
        $data = [
            ...
            ['name' => 'view-web-settings', "description" => 'Access to set a web Setting', 'status' => 1, 'created_at' => date('Y-m-d H:i:s')],
            ...
            ['name' => 'view-roles', "description" => 'Access to list all Roles', 'status' => 1, 'created_at' => date('Y-m-d H:i:s')],
            ...
            ['name' => 'view-offers', "description" => 'Access to view all offers', 'status' => 1, 'created_at' => date('Y-m-d H:i:s')],
