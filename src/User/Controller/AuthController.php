...
class AuthController extends BaseController
{
    ...
    public function register(Request $request, Response $response): Response
    {
        ...
        $this->validationService->validate($parsedData, [
            UserInterface::COLUMN_USERNAME => 'required|min:3|max:12|regex:/^[a-zA-Z]+([\.:_\-=!\?]){0,5}([a-zA-Z0-9])+$/',
            ...
            UserInterface::COLUMN_PASSWORD => 'required|min:6','password_confirmation' => 'required|same:password'
        ]);
